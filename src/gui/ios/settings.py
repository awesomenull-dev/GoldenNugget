...
class IOSSettingsPage(QWidget):
    ...
    def _on_reset_pairing_clicked(self):
        ...
        # Hold the thread on this page: a bare local reference lets the Python
        # wrapper be garbage-collected while the native thread is still
        # running, which Qt reports as "QThread: Destroyed while thread '' is
        # still running" and aborts.
